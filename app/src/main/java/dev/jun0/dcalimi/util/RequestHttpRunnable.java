...
public class RequestHttpRunnable implements Runnable {
    private final Handler mHandler;
    private final Context mContext;
    private final int mGrade;
    private final SchoolClass.OnDownloadTotalNumberCompleteListener mOnDownloadTotalNumberCompleteListener;

    RequestHttpRunnable(FragmentManager fragmentManager, View view, int grade, SchoolClass.OnDownloadTotalNumberCompleteListener onDownloadTotalNumberCompleteListener){
    ...
    private void sendHandlerCallDownloadComplete(int totalNum, SchoolClass.OnDownloadTotalNumberCompleteListener onDownloadCompleteListener){
        Message msg = new Message();
